<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Author.aspx.cs" Inherits="LibraryManagement.Author" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-group" style="margin-top: 40px;">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorAuthorName" ValidationGroup="Save" runat="server" ControlToValidate="txtAuthorName" ErrorMessage="Please enter teacher name" ForeColor="#993333"></asp:RequiredFieldValidator>
    </div>
