<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateStudent.aspx.cs" Inherits="LibraryManagement.UpdateStudent" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="Delete" runat="server" class="btn btn-danger pull-right" Text="Reset" OnClick="Delete_Click" />
